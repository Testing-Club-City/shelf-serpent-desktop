...
pub mod borrowing_request;
pub use borrowing_request::BorrowingCreateRequest;
...
pub struct DashboardData {
    ...
    pub total_borrowings: i64,
    pub overdue_books: i64,
    pub categories_count: i64,
    pub total_fines: i64,
    pub recent_borrowings: Vec<BorrowingWithDetails>,
    pub popular_books: Vec<BookWithDetails>,
}

...
export const DashboardOverview = ({ onTabChange, onQuickAction }: DashboardOverviewProps) => {
  // Use ultra-fast dashboard stats instead of individual hooks
  ...
  // Use dashboard stats directly for ultra-fast loading
  const totalBooks = dashboardStats?.totalBooks || 0;
  const totalStudents = dashboardStats?.totalUsers || 0;
  const activeBorrowings = dashboardStats?.activeBorrowings || 0;
  const overdueBorrowings = dashboardStats?.overdueBorrowings || 0;

  // Prepare stats cards data with unified loading state
  const stats = [
    {
      title: 'Total Books',
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-green-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Returns This Month</p>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-red-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">With borrowed books</p>
                    </div>
                  </div>

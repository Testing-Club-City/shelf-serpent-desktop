...
export class OfflineDataService {
  ...
  static async getBorrowingsByStudent(studentId: string): Promise<any[]> {
    try {
      return await invoke('get_borrowings_by_student', { studentId });
    } catch (error) {
      console.error('Failed to get borrowings by student:', error);
      throw error;
    }
  }

  static async getBorrowingsByStaff(staffId: string): Promise<any[]> {
    try {
      return await invoke('get_borrowings_by_staff', { staffId });
    } catch (error) {
      console.error('Failed to get borrowings by staff:', error);
      throw error;
    }
  }
  ...
  static async createGroupBorrowing(groupBorrowingData: any): Promise<string> {
    try {
      return await invoke('create_group_borrowing', { groupBorrowingData: groupBorrowingData });
    } catch (error) {
  ...
  static async updateGroupBorrowing(groupBorrowingId: string, groupBorrowingData: any): Promise<void> {
    try {
      await invoke('update_group_borrowing', { groupBorrowingId: groupBorrowingId, groupBorrowingData: groupBorrowingData });
    } catch (error) {
  ...
  static async returnGroupBorrowing(groupBorrowingId: string, returnData: any): Promise<void> {
    try {
      console.log('🔄 Calling return_group_borrowing with:', { groupBorrowingId: groupBorrowingId, returnData: returnData });
      await invoke('return_group_borrowing', { groupBorrowingId: groupBorrowingId, returnData: returnData });
      console.log('✅ Group borrowing return completed successfully');
    } catch (error) {
  ...
  static async upsertGroupBorrowing(groupBorrowingData: any): Promise<void> {
    try {
      await invoke('upsert_group_borrowing', { groupBorrowingData: groupBorrowingData });
    } catch (error) {
  ...
  static async getFinesByStaff(staffId: string): Promise<any[]> {
    try {
      return await invoke('get_fines_by_staff', { staffId });
    } catch (error) {
      console.error('Failed to get fines by staff:', error);
      throw error;
    }
  }
  ...
  static async searchBookCopyById(bookId: number): Promise<any> {
    try {
      return await invoke('search_book_copy_by_id', { bookId: bookId });
    } catch (error) {
      console.error('Failed to search book copy by ID:', error);
      throw error;
    }
  }

  static async searchStudentByAdmission(admissionNumber: string): Promise<any> {
    try {
      return await invoke('search_student_by_admission', { admissionNumber });
    } catch (error) {
      console.error('Failed to search student by admission:', error);
      throw error;
    }
  }

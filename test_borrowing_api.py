...
def test_borrowing_response():
    conn = sqlite3.connect(DB_PATH)
    conn.row_factory = sqlite3.Row
    
    # Simulate the exact query from get_borrowings_with_details
    query = """
        SELECT 
        ...
        WHERE b.deleted = 0 AND b.borrower_type = 'staff'
    ...
    print("Sample staff borrowing API responses:")
    print("=" * 50)
    ...
    for row in rows:
        ...
        print(f"Copy Identifier: {row['copy_number']}")

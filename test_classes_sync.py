...
# Test script to verify the classes sync issue
...
def test_classes_count():
    ...
    if response.status_code == 200:
        ...
        if '/' in content_range:
            ...
            print(f"   ⚠️ No content-range header found")
    else:
    ...
    print("\n2️⃣ Testing ACTIVE classes count (what professional sync manager counts):")
    ...
    print("\n3️⃣ Getting sample classes data:")
